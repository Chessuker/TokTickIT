// Lab 1 diagnostics page: API health, the demo user guestbook and the category
// list. Kept reachable from the Lab 2 shell at /system so the Lab 1 deliverable
// stays demonstrable; the Lab 2 screens are the ones under docs/lab-02.
